  ...
  try {
    ...
    alarmTask = cron.schedule('*/15 * * * *', async () => {
      ...
      try {
        ...
        // Verificar alarmas de oportunidades y citas
        const resultadoOportunidadesYCitas = await verificarAlarmas();
        console.log('[BOLETOS-SCHEDULER] Verificación de alarmas de oportunidades y citas completada:', resultadoOportunidadesYCitas);
      } catch (error) {
    ...
    Promise.all([
      ...
      verificarAlarmas()
    ]).then(([resultadoBoletos, resultadoUnidadesParadas, resultadoLegales, resultadoOportunidadesYCitas]) => {
      ...
      console.log('[BOLETOS-SCHEDULER] Verificación inicial de alarmas de oportunidades y citas completada:', resultadoOportunidadesYCitas);
    }).catch(error => {
