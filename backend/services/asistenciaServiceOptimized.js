...
/**
 * Servicio optimizado: datos reales con consultas eficientes
 */
export async function getCitasConAsistencia(filters = {}, pagination = {}) {
  try {
    ...
    // Obtener solo las primeras 25 citas para evitar timeout
      ...
      if (cita['Fecha ci'] && cita.Matricula) {
        try {
          ...
          if (!isNaN(fechaCita.getTime())) {
            ...
            // Buscar ingreso con timeout corto
            ...
            }).select('Referencia Fecaper').lean().maxTimeMS(3000);
