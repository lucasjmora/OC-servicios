...
/**
 * Servicio balanceado: datos reales con procesamiento optimizado
 */
export async function getCitasConAsistencia(filters = {}, pagination = {}) {
  try {
    ...
    console.log(`📊 Servicio BALANCEADO - Estado: ${estadoAsistencia}, Página: ${page}`);
    ...
    // Obtener ingresos para las matrículas encontradas (con timeout)
    ...
    console.log(`📊 Resumen BALANCEADO: ${conAsistencia} asistieron, ${sinAsistencia} no asistieron`);
    ...
    console.error('Error en servicio BALANCEADO:', error);
    throw error;
  }
}
